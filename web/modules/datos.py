...
Exporta:
    ...
    run_descargar_datos()   — Descarga cervantes.txt desde Project Gutenberg
"""
...
def elegir_corpus() -> str | None:
    ...
    print("   Descárgalo desde la interfaz web: Descargar Corpus de Cervantes")
    print()
...
# ─────────────────────────────────────────────────────────────────────────────
# Punto de entrada (se ejecuta desde la interfaz web)
# ─────────────────────────────────────────────────────────────────────────────

def run_descargar_datos():
    """Descarga cervantes.txt desde Project Gutenberg."""
