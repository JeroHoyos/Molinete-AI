...
def _entrenar_modelo(
    ...
    config_nombre es el constructor de molineteai.Config a usar
    ("diminuta", "pequena", "mediana", "gpt2_small"); se resuelve aquí
    para no importar molineteai antes de verificar que está instalado.
    ...
    import molineteai
    config_fn = getattr(molineteai.Config, config_nombre)
